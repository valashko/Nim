/* Generated by the Nim Compiler v1.1.0 */
...
function to_toc_194688(x_194690, father_194691) {
	...
	framePtr = F;
		...
		L12: do {
			...
			if (!((idx_194788 != null ? idx_194788.length : 0) == 2)) Tmp15 = false; else {				Tmp15 = (x_194690.childNodes[idx_194788[chckIndx(1, 0, (idx_194788 != null ? idx_194788.length : 0)+0-1)-0]].nodeName == "UL");			}		if (Tmp15) {
		F.line = 164;
		var e_194829 = {heading: x_194690.childNodes[idx_194788[chckIndx(0, 0, (idx_194788 != null ? idx_194788.length : 0)+0-1)-0]], kids: [], sortId: (father_194691.kids != null ? father_194691.kids.length : 0), doSort: false};
		F.line = 166;
		var it_194830 = x_194690.childNodes[idx_194788[chckIndx(1, 0, (idx_194788 != null ? idx_194788.length : 0)+0-1)-0]];
		L16: do {
			F.line = 167;
			var j_194838 = 0;
			F.line = 2756;
			...
			L3: do {
				F.line = 2759;
					...
					if (!(i_195488 < colontmp__195487)) break L4;
						...
						i_194374 = i_195488;
						F.line = 84;
						if (items_194345[items_194345_Idx] != null) { items_194345[items_194345_Idx].push(x_194341.kids[chckIndx(i_194374, 0, (x_194341.kids != null ? x_194341.kids.length : 0)+0-1)-0].heading); } else { items_194345[items_194345_Idx] = [x_194341.kids[chckIndx(i_194374, 0, (x_194341.kids != null ? x_194341.kids.length : 0)+0-1)-0].heading]; };
						F.line = 2761;
				...
				L6: do {
					F.line = 2759;
						...
						if (!(i_195493 < colontmp__195492)) break L7;
							...
							i_194394 = i_195493;
							F.line = 87;
							var it_194395 = x_194341.kids[chckIndx(i_194394, 0, (x_194341.kids != null ? x_194341.kids.length : 0)+0-1)-0];
							F.line = 88;
			...
			L2: do {
				F.line = 4;
					...
					if (!(i_195510 < (kids_194024 != null ? kids_194024.length : 0))) break L3;
						F.line = 12;
						k_194056 = kids_194024[chckIndx(i_195510, 0, (kids_194024 != null ? kids_194024.length : 0)+0-1)-0];
						F.line = 13;
			...
			L4: do {
				F.line = 2759;
					...
					if (!(i_195523 < colontmp__195522)) break L5;
						...
						i_194994 = i_195523;
						F.line = 198;
						var y_194995 = uncovered_194950(x_194952.kids[chckIndx(i_194994, 0, (x_194952.kids != null ? x_194952.kids.length : 0)+0-1)-0]);
						if (!((y_194995 == null))) {
						F.line = 199;
				...
				L2: do {
					F.line = 2759;
						...
						if (!(i_195517 < colontmp__195516)) break L3;
							...
							i_195054 = i_195517;
							F.line = 208;
							if (result_195033.kids != null) { result_195033.kids.push(news_195032.kids[chckIndx(i_195054, 0, (news_195032.kids != null ? news_195032.kids.length : 0)+0-1)-0]); } else { result_195033.kids = [news_195032.kids[chckIndx(i_195054, 0, (news_195032.kids != null ? news_195032.kids.length : 0)+0-1)-0]]; };
							F.line = 2761;
			...
			L2: do {
				F.line = 186;
					...
					if (!(i_195505 < l_195506)) break L3;
						F.line = 212;
						t_195214 = types_195079[chckIndx(i_195505, 0, (types_195079 != null ? types_195079.length : 0)+0-1)-0];
						F.line = 213;
							...
							L5: do {
								F.line = 186;
									...
									if (!(i_195502 < l_195503)) break L6;
										F.line = 215;
										p_195237 = procs_195080[chckIndx(i_195502, 0, (procs_195080 != null ? procs_195080.length : 0)+0-1)-0];
										if (!(p_195237.hasOwnProperty('__karaxMarker__'))) {
										F.line = 217;
										var xx_195238 = p_195237.parentNode.getElementsByClassName("attachedType");
										if ((((xx_195238 != null ? xx_195238.length : 0) == 1) && (xx_195238[chckIndx(0, 0, (xx_195238 != null ? xx_195238.length : 0)+0-1)-0].textContent == t_195214.textContent))) {
										F.line = 220;
										...
										F.line = 189;
										failed_assert_impl_55666(makeNimstrLit("/Users/travis/build/nim-lang/Nim/lib/system/iterators.nim(189, 11) `len(a) ==\x0A    L` the length of the seq changed while iterating over it"));
										}
			...
			L3: do {
				F.line = 186;
					...
					if (!(i_195531 < l_195532)) break L4;
						F.line = 115;
						k_194614 = colontmp__195529[chckIndx(i_195531, 0, (colontmp__195529 != null ? colontmp__195529.length : 0)+0-1)-0];
						F.line = 116;
...
function groupBy(value_195351) {
	...
	framePtr = F;
		...
		F.line = 242;
		tt_195373 = tt_195373.kids[chckIndx(0, 0, (tt_195373.kids != null ? tt_195373.kids.length : 0)+0-1)-0];
		F.line = 244;
		var types_195390 = [[]];
		F.line = 245;
		var procs_195407 = [[]];
		...
		L1: do {
			F.line = 49;
				...
				if (!((str_index_193082 < (str_193070 != null ? str_193070.length : 0)) && (pat_index_193084 < (pattern_193069 != null ? pattern_193069.length : 0)))) break L2;
					L3: do {
						F.line = 51;
						var pattern_char_193092 = nsuToLowerAsciiChar(pattern_193069.charCodeAt(chckIndx(pat_index_193084, 0, (pattern_193069 != null ? pattern_193069.length : 0)+0-1)-0));
						F.line = 52;
						var str_char_193093 = nsuToLowerAsciiChar(str_193070.charCodeAt(chckIndx(str_index_193082, 0, (str_193070 != null ? str_193070.length : 0)+0-1)-0));
						...
						case 5:
							...
							F.line = 91;
							var next_pattern_char_193168 = nsuToLowerAsciiChar(pattern_193069.charCodeAt(chckIndx(addInt(pat_index_193084, 1), 0, (pattern_193069 != null ? pattern_193069.length : 0)+0-1)-0));
							F.line = 92;
							var next_str_char_193169 = nsuToLowerAsciiChar(str_193070.charCodeAt(chckIndx(addInt(str_index_193082, 1), 0, (str_193070 != null ? str_193070.length : 0)+0-1)-0));
							F.line = 95;
						...
						case -3:
							F.line = 103;
							if (!((ConstSet6[str_193070.charCodeAt(chckIndx(subInt(str_index_193082, 1), 0, (str_193070 != null ? str_193070.length : 0)+0-1)-0)] != undefined))) Tmp5 = true; else {								if (!(ConstSet7[str_193070.charCodeAt(chckIndx(subInt(str_index_193082, 1), 0, (str_193070 != null ? str_193070.length : 0)+0-1)-0)] != undefined)) Tmp6 = false; else {									Tmp6 = (ConstSet8[str_193070.charCodeAt(chckIndx(str_index_193082, 0, (str_193070 != null ? str_193070.length : 0)+0-1)-0)] != undefined);								}								Tmp5 = Tmp6;							}							var is_leading_char_193207 = Tmp5;
			...
			L2: do {
				F.line = 186;
					...
					if (!(i_196045 < l_196046)) break L3;
						F.line = 288;
						ahref_195814 = db_195535[0][chckIndx(i_196045, 0, (db_195535[0] != null ? db_195535[0].length : 0)+0-1)-0];
						F.line = 289;
			...
			L5: do {
				F.line = 2759;
					...
					if (!(i_196053 < colontmp__196052)) break L6;
						...
						L7: do {
							F.line = 295;
							var c_195860 = contents_195537[0][chckIndx(i_195859, 0, (contents_195537[0] != null ? contents_195537[0].length : 0)+0-1)-0];
							...
							if (matched_195862) {
							F.line = 303;
							if (matches_195846 != null) { matches_195846.push({Field0: db_195535[0][chckIndx(i_195859, 0, (db_195535[0] != null ? db_195535[0].length : 0)+0-1)-0], Field1: score_195861}); } else { matches_195846 = [{Field0: db_195535[0][chckIndx(i_195859, 0, (db_195535[0] != null ? db_195535[0].length : 0)+0-1)-0], Field1: score_195861}]; };
							}
			...
			L9: do {
				F.line = 2759;
					...
					if (!(i_196059 < colontmp__196058)) break L10;
						...
						i_195926 = i_196059;
						F.line = 307;
						matches_195846[chckIndx(i_195926, 0, (matches_195846 != null ? matches_195846.length : 0)+0-1)-0]["Field0"].innerHTML = matches_195846[chckIndx(i_195926, 0, (matches_195846 != null ? matches_195846.length : 0)+0-1)-0]["Field0"].getAttribute("data-doc-search-tag");
						F.line = 308;
						add_194085(ul_195825, tree_194020(makeNimstrLit("LI"), [matches_195846[chckIndx(i_195926, 0, (matches_195846 != null ? matches_195846.length : 0)+0-1)-0]["Field0"]]));
						F.line = 2761;
